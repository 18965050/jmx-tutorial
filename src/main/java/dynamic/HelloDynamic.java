...
public class HelloDynamic implements DynamicMBean {
	...
	private void buildDynamicMBean() {
		...
		constructors[0] = new MBeanConstructorInfo("HelloDynamic(): Constructs a HelloDynamic object",
				thisconstructors[0]);
		// 设定一个属性
	...
	private void dynamicAddOperation() {
		...
		buildDynamicMBean();
		operations[1] = new MBeanOperationInfo("print1", "print1(): print the name", null, "void",
				MBeanOperationInfo.INFO);
		mBeanInfo = new MBeanInfo(className, description, attributes, constructors, operations,
				mBeanNotificationInfoArray);
	}
